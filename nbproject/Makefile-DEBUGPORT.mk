...
ifeq "$(wildcard nbproject/Makefile-local-DEBUGPORT.mk)" "nbproject/Makefile-local-DEBUGPORT.mk"
include nbproject/Makefile-local-DEBUGPORT.mk
endif
endif
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-DEBUGPORT.mk dist/${CND_CONF}/${IMAGE_TYPE}/CS020_MasterMCU_2PcCase.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/master.p1: master.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=icd3    --double=32 --float=32 --emi=wordwrite --opt=+asm,-asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -DJS -DDEBUGPORT -P -N255 -I"." -I"C:/Program Files (x86)/Microchip/xc8/v1.33/include" -I"C:/Program Files (x86)/Microchip/xc8/v1.33/include/plib" --warn=-1 --asmlist -DXPRJ_DEBUGPORT=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,-config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf --stack=compiled "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/master.p1 master.c 
...
${OBJECTDIR}/_ext/1477896233/writdata.p1: ../CS020_MasterMCU/EL04/xlcd/writdata.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=icd3    --double=24 --float=24 --emi=wordwrite --opt=+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 -I"../../../../cs020_sw/Master_v1p224p34-XC8/EL04/main" -I"C:/Program Files (x86)/Microchip/xc8/v1.31/include" -I"C:/Program Files (x86)/Microchip/xc8/v1.31/include/plib" -I"." --warn=0 --asmlist -DXPRJ_DEBUGPORT=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf --stack=compiled "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/1477896233/writdata.p1 ../CS020_MasterMCU/EL04/xlcd/writdata.c 
...
${OBJECTDIR}/master.p1: master.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	@${RM} ${OBJECTDIR}/master.p1.d 
	@${RM} ${OBJECTDIR}/master.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G    --double=32 --float=32 --emi=wordwrite --opt=+asm,-asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -DJS -DDEBUGPORT -P -N255 -I"." -I"C:/Program Files (x86)/Microchip/xc8/v1.33/include" -I"C:/Program Files (x86)/Microchip/xc8/v1.33/include/plib" --warn=-1 --asmlist -DXPRJ_DEBUGPORT=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,-config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf --stack=compiled "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/master.p1 master.c 
	@-${MV} ${OBJECTDIR}/master.d ${OBJECTDIR}/master.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/master.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/_ext/1477896233/writdata.p1: ../CS020_MasterMCU/EL04/xlcd/writdata.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	@${RM} ${OBJECTDIR}/_ext/1477896233/writdata.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1477896233/writdata.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G    --double=24 --float=24 --emi=wordwrite --opt=+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 -I"../../../../cs020_sw/Master_v1p224p34-XC8/EL04/main" -I"C:/Program Files (x86)/Microchip/xc8/v1.31/include" -I"C:/Program Files (x86)/Microchip/xc8/v1.31/include/plib" -I"." --warn=0 --asmlist -DXPRJ_DEBUGPORT=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib $(COMPARISON_BUILD)  --output=-mcof,+elf --stack=compiled "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/1477896233/writdata.p1 ../CS020_MasterMCU/EL04/xlcd/writdata.c 
	@-${MV} ${OBJECTDIR}/_ext/1477896233/writdata.d ${OBJECTDIR}/_ext/1477896233/writdata.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1477896233/writdata.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
dist/${CND_CONF}/${IMAGE_TYPE}/CS020_MasterMCU_2PcCase.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/CS020_MasterMCU_2PcCase.X.${IMAGE_TYPE}.map  -D__DEBUG=1  --debugger=icd3  -DXPRJ_DEBUGPORT=$(CND_CONF)    --double=32 --float=32 --emi=wordwrite --opt=+asm,-asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -DJS -DDEBUGPORT -P -N255 -I"." -I"C:/Program Files (x86)/Microchip/xc8/v1.33/include" -I"C:/Program Files (x86)/Microchip/xc8/v1.33/include/plib" --warn=-1 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,-config,+clib,+plib --output=-mcof,+elf --stack=compiled "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     --rom=default,-1fd30-1ffff --ram=default,-ef4-eff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff  $(COMPARISON_BUILD)  -odist/${CND_CONF}/${IMAGE_TYPE}/CS020_MasterMCU_2PcCase.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/CS020_MasterMCU_2PcCase.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/CS020_MasterMCU_2PcCase.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/CS020_MasterMCU_2PcCase.X.${IMAGE_TYPE}.map  -DXPRJ_DEBUGPORT=$(CND_CONF)    --double=32 --float=32 --emi=wordwrite --opt=+asm,-asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -DJS -DDEBUGPORT -P -N255 -I"." -I"C:/Program Files (x86)/Microchip/xc8/v1.33/include" -I"C:/Program Files (x86)/Microchip/xc8/v1.33/include/plib" --warn=-1 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,-config,+clib,+plib --output=-mcof,+elf --stack=compiled "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD)  -odist/${CND_CONF}/${IMAGE_TYPE}/CS020_MasterMCU_2PcCase.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
